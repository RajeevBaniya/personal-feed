...
export default function ContentCard({ 
  ...
  return (
    <div className="relative group">
      ...
      <div className={`relative z-10 rounded-3xl overflow-hidden shadow-2xl transition-all duration-300 group-hover:shadow-3xl bg-gradient-to-br ${gradientColors}`}>
